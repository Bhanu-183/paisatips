...
<head>
	...
	<title>PaisaTips | Cryptocurrency</title>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crpto-about">
						<h3 class="about-currency">About Cryptocurrency</h3>
		...
		<div class="container">
			...
			<div data-aos="fade-right">
				<div class="container mt-3">
					<div class="Cryptocurrency-tips">
						<h4><span>1</span>Research Exchanges</h4>
						<p>Before you invest one dollar, learn about cryptocurrency exchanges. These platforms provide the means to buy and sell digital currencies, but there are 500 exchanges to choose from, according to Bitcoin.com. Do your research, read reviews and talk with more experienced investors before moving forward.</p>
					</div>
				</div>
			</div>
			...
			<div data-aos="fade-left">
				<div class="container mt-3">
					<div class="Cryptocurrency-tips">
						<h4><span>2</span>Know How to Store Your Digital Currency</h4>
						<p>If you buy cryptocurrency, you have to store it. You can store it on an exchange or in a digital "wallet," for example one of the crypto wallets described in our Blog post Which cryptocurrency wallet to choose. While there are many different kinds of wallets, each has its own benefits, technical requirements and security. As with exchanges, you should investigate your storage choices before investing.</p>
					</div>
				</div>
			</div>
			...
			<div data-aos="fade-right">
				<div class="container mt-3">
					<div class="Cryptocurrency-tips">
						<h4><span>3</span>Diversify Your Investments</h4>
						<p>Diversification is a key to any good investment strategy, and it holds true when you're investing in cryptocurrency too. Don't put all of your money in Bitcoin, for example, just because that's the name you know. There are thousands of options, and it's best to spread your investment around to several currencies.</p>
					</div>
				</div>
			</div>
			...
			<div data-aos="fade-left">
				<div class="container mt-3">
					<div class="Cryptocurrency-tips">
						<h4><span>4</span>Prepare for Volatility</h4>
						<p>The cryptocurrency market is a volatile one, so be prepared for ups and downs. You'll see dramatic swings in prices. If your investment portfolio or mental wellbeing can't handle that, cryptocurrency might not be a wise choice for you.</p>
					</div>
				</div>
			</div>
		</div>
